...
func New(ctx context.Context, informerFactory informers.SharedInformerFactory, customInformerFactory externalversions.SharedInformerFactory) (*Scheduler, error) {
	scheduler := &Scheduler{
